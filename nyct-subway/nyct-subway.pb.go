...
func (NyctTripDescriptor_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_nyct_subway_9a8060c52ab67659, []int{2, 0}
}
...
func (*TripReplacementPeriod) Descriptor() ([]byte, []int) {
	return fileDescriptor_nyct_subway_9a8060c52ab67659, []int{0}
}
...
func (*NyctFeedHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_nyct_subway_9a8060c52ab67659, []int{1}
}
...
func (*NyctTripDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_nyct_subway_9a8060c52ab67659, []int{2}
}
...
func (*NyctStopTimeUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_nyct_subway_9a8060c52ab67659, []int{3}
}
...
func init() { proto.RegisterFile("nyct-subway.proto", fileDescriptor_nyct_subway_9a8060c52ab67659) }

var fileDescriptor_nyct_subway_9a8060c52ab67659 = []byte{
